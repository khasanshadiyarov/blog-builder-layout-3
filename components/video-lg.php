...
try {
    if (!$video) {
        throw new Exception('Error: No <b>video</b> provided to component: ' . __FILE__);
    }
}
catch (Exception $e)
{
...
<div class="video video-lg">
    ...
    <div class="platter-inner">
        ...
        <a href="<?= $video['author_url'] ?>" target="_blank" class="platter-ref">
                <span class="preview-symbol"><img
                        src="<?= $video['author_image'] ?>"
                        alt="<?= $video['author_name'] ?>"></span>
            <?= $video['author_name'] ?>
        </a>
    </div>
    <div class="platter-footer">
        ...
        <span>
                All videos are copyrighted by <a href="https://creativecommons.org/">Creative Commons</a>
